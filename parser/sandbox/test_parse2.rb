...
## Round of 16 - 1st Leg
##  add support for - here - why? why not?
##    not gets tokenized as :vs (change back to generic :-   - why? why not?)
##     and only keep :vs for v|vs - why? why not?
##
